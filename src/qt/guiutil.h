...
/** Utility functions used by the Oryxcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render ORYX addresses in monospace font
...
// Parse "oryxcoin:" URI into recipient object, return true on successful parsing
