...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Oryxcoin features */
        {"oryxcoin", "masternode", &masternode, true, true, false},
        {"oryxcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"oryxcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"oryxcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"oryxcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"oryxcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"oryxcoin", "startmasternode", &startmasternode, true, true, false},
        {"oryxcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"oryxcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"oryxcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"oryxcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"oryxcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"oryxcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"oryxcoin", "mnbudget", &mnbudget, true, true, false},
        {"oryxcoin", "preparebudget", &preparebudget, true, true, false},
        {"oryxcoin", "submitbudget", &submitbudget, true, true, false},
        {"oryxcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"oryxcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"oryxcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"oryxcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"oryxcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"oryxcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"oryxcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"oryxcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"oryxcoin", "mnsync", &mnsync, true, true, false},
        {"oryxcoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> oryxcoin-cli " + methodname + " " + args + "\n";
}
