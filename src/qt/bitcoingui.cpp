                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Oryxcoin Core") + " - ";
#ifdef ENABLE_WALLET
    ...
    if (curStyle == "QWindowsStyle" || curStyle == "QWindowsXPStyle") {
        progressBar->setStyleSheet("QProgressBar { background-color: #F2F2F2; border: 1px solid grey; border-radius: 7px; padding: 1px; text-align: center; } QProgressBar::chunk { background: QLinearGradient(x1: 0, y1: 0, x2: 1, y2: 0, stop: 0 #00CCFF, stop: 1 #33CCFF); border-radius: 7px; margin: 0px; }");
    }
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ORYX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and oryxcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Oryxcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Oryxcoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ORYX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ORYX addresses"));
    ...
    openAction->setStatusTip(tr("Open a oryxcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Oryxcoin Core help message to get a list with possible Oryxcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Oryxcoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Oryxcoin Core"); // default title
