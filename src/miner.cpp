...
bool ProcessBlockFound(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    if (!ProcessNewBlock(state, NULL, pblock))
        return error("OryxcoinMiner : ProcessNewBlock, block not accepted");
...
{
    LogPrintf("OryxcoinMiner started\n");
    ...
    while (fGenerateBitcoins || fProofOfStake) {
        ...
        LogPrintf("Running OryxcoinMiner with %u transactions in block (%u bytes)\n", pblock->vtx.size(),
