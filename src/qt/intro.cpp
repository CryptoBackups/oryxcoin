...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Oryxcoin Core"),
     ...
     * override -datadir in the oryxcoin.conf file in the default data directory
     * (to be consistent with oryxcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
